 ...
 * @author Pedro Caleia
 */
public final class MeetInTheMiddleSolverTest {
	
	
	private static IntegerProcessor INTEGER_PROCESSOR;
	private static LongProcessor LONG_PROCESSOR;
	
	
	@BeforeAll
	public static void beforeAll() {
		INTEGER_PROCESSOR = new IntegerProcessor();
	...
	public void test1() {
		...
		// Solver
		MeetInTheMiddleSolver<Integer, Long> solver = new MeetInTheMiddleSolver<>( INTEGER_PROCESSOR, LONG_PROCESSOR );
